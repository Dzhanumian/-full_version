...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        <p><strong style="font-size: 20px">Регистрация пользователя</strong></p>
        <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('role')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ 'Выберете одну из этих ролей: admin , teacher, owner' }}</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="role" class="col-md-4 col-form-label text-md-right">{{ __('Будет преподавать ?') }}</label>
