      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <select class="form-control select2 @error('group_id') is-invalid @enderror"  name="group_id" autofocus autocomplete="group_id">
                  <option selected>Пробное занятие</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <select required multiple class="form-control select2 @error('students') is-invalid @enderror"  name="students[]" autofocus autocomplete="students">
