...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!-- <button class="btn btn-success" style="margin-top: -30px;">Назад</button> -->
      <div class="box">
        <p><strong style="font-size: 20px">Редактирование урока</strong></p>
        ...
        <div class="box-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <select class="form-control select2 @error('teacher_id') is-invalid @enderror"  name="teacher_id" autofocus autocomplete="teacher_id">
                  <option value="{{ $teaches->id }}">{{ $teaches->surname.' '.$teaches->name }}</option>
          ...
          <!----------------------------------------------------->
          <input type="hidden" name="students" value="9999">
          <!----------------------------------------------------->
          <div class="form-group row">
            <label for="students" class="col-md-2 col-form-label text-md-right">{{ __('Занятие для студентов ') }}</label>
            <div class="col-md-6">
                <select class="form-control select2 @error('students') is-invalid @enderror"  name="students[]" autofocus autocomplete="students" multiple>
                @foreach($dataUpdateLesson[0] as $student)
                  <option selected value="{{ $student->id }}">{{ $student->surname.' '.$student->name}}</option>
                @endforeach
                @foreach($dataUpdateLesson['students'] as $student)
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <option value="{{ $lesson->room }}">{{ $room->subsidiaries_name.': '.$room->room_name }}</option>  
