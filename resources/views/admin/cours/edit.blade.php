...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        <p><strong style="font-size: 20px">Редактирование курсов</strong></p>
        <div class="box-body">
          <form method="POST" action="{{route('course.update', $cours->id)}}">
          @method('PATCH')
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="course_name" type="text" class="form-control @error('course_name') is-invalid @enderror" name="course_name"  placeholder="Название" autocomplete="course_name" autofocus value="{{ $cours->course_name }}">
                @error('course_name')
           ...
           <div class="form-group row">
            ...
            <div class="col-md-6">
              <select class="form-control select2 @error('level') is-invalid @enderror"  name="level" autofocus autocomplete="level">
                <option>{{ $cours->level }}</option>
                <option>А1 - Beginner</option>
                <option>A1 - Elementary</option>
