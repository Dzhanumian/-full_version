...
@section('content')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        <p><strong style="font-size: 20px">Редактирование кабинета</strong></p>
        <div class="box-body">
          <form method="POST" action="{{route('class_room.update', $room->id)}}">
          @method('PATCH')
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              <select class="form-control select2 @error('subsidiaries_name') is-invalid @enderror"  name="subsidiaries_name" autofocus autocomplete="subsidiaries_name">
                <option>{{ $room->subsidiaries_name }}</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="room_name" type="text" class="form-control @error('room_name') is-invalid @enderror" name="room_name"  placeholder="Название кабинета" autocomplete="room_name" autofocus value="{{ $room->room_name }}">
                @error('room_name')
                    <span class="invalid-feedback" role="alert">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="seating_capacity" type="text" class="form-control @error('seating_capacity') is-invalid @enderror" name="seating_capacity"  placeholder="Количество мест" autocomplete="seating_capacity" autofocus value="{{ $room->seating_capacity }}">
