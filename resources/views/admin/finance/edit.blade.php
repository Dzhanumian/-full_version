          ...
          @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                  ...
                  <input id="how_many" type="text" class="form-control @error('how_many') is-invalid @enderror" name="how_many" autocomplete="how_many" autofocus required value="{{ $finance->quantity }}">
