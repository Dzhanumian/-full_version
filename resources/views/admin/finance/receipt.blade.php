        ...
        <div class="box-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                  ...
                  <input id="account" type="text" class="form-control @error('account') is-invalid @enderror" name="account" value="{{ $recommended }}"  autocomplete="account" autofocus required>
