...
<ul class="sidebar-menu">
    ...
    <li class="treeview"><a href="/dashboard"><i class="fa fa-dashboard"></i><span>Главная страница</span></a></li>
    ...
    <li><a href="/dashboard/students"><i class="fa fa-child"></i> <span>Студенты</span></a></li>
    <li><a href="/dashboard/lesson_week"><i class="fa fa-table"></i> <span>Уроки</span></a></li>

    <li><a href="/dashboard/finance"><i class="fa fa-money"></i> <span>Финансы</span></a></li>
...
<ul class="sidebar-menu">
    <li class="header">Dashboard</li>
    <li class="treeview"><a href="/dashboard"><i class="fa fa-dashboard"></i><span>Главная страница</span></a></li>
    <li><a href="/dashboard/students"><i class="fa fa-users"></i> <span>Студенты</span></a></li>
    <li><a href="/dashboard/lesson_week/{{ strtotime(date('Y-m-d')).'/'.Auth::user()->id.'/0/0' }}"><i class="fa fa-table"></i> <span>Уроки</span></a></li>
</ul>
@endif
